...
export const Menu = ({ onSelectMode, onLogin }: MenuProps) => {
  ...
  return (
    <div id='menu' className='roulette-menu flex flex-col items-center gap-4 p-8 rounded-lg'>
      <h1 className='text-3xl font-bold text-white mb-6'>Selecciona un modo de juego</h1>
